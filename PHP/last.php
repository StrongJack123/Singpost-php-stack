...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid">
            <p>
            <div class="status active" style="background-color: lightgreen; color: white; padding: 20px;">
                <h1>Delivery status has been updated!</h1>
                <div>Your delivery will be delivered to you as soon as possible.
                    https://www.singpost.com/support-centre，If
                    you have any questions, please contact SingPost Customer Support.</div>
            </div>
            </p>
